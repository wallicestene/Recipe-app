      ...
      <div className="nav-right  w-1/2 ">
        ...
        <div className="nav-left flex items-center gap-2 ">
          <div onClick={() => setShowLogOut(!showLogOut) } className=' cursor-pointer' >
            <h1 className=' text-sm text-gray-500 font-LosefinSans first-letter:uppercase text-clip'>{user.displayName ? user.displayName : "Profile"}{showLogOut ? <KeyboardArrowUp fontSize='small'/> : <KeyboardArrowDown fontSize='small'/>}</h1>
          </div>
