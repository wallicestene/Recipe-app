...
const Filterpage = ({ searchMeal, showFavourites, setShowFavourites }) => {
  ...
  return (
    <div className="filterpage flex items-center justify-between mt-5">
        ...
        <form className="flex gap-3 items-center" onSubmit={handleSubmit}>
          <div className="  flex items-center rounded-full shadow-xl w-64 border lg:w-96 p-1">
            ...
            <input
              ...
              className="lg:py-2 py-2 outline-none bg-transparent w-full indent-3"
      ...
      <div
        className="filter-right hover:cursor-pointer flex items-center text-2xl bg-rose-500 py-3 p-1 gap-1 lg:gap-3 lg:p-3 text-white rounded-md"
